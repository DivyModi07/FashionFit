  ...
  useEffect(() => {
    ...
    axios.get('http://127.0.0.1:8000/api/products/all/')
      .then(res => {
        ...
        const trendingProducts = allProducts.filter(p => p.discount > 0);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              <TrendingUp className="w-10 h-10 inline mr-4 text-purple-600" />
              <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                Trending Deals
              </span>
            </h1>
            <p className="text-xl text-gray-600">The hottest items on sale right now</p>
          </div>
