...
//                     }`}
//                   >
//                     <Heart className={`w-6 h-6 ${displayProduct.isWishlisted ? "fill-current" : ""}`} />
//                   </button>
//                 </div>
//               </div>
...
//                             className={`w-16 h-16 rounded-xl border-4 transition-all duration-300 transform hover:scale-105 ${
//                               selectedColor === color
